      ...
      " id="login-wrapper"> 
          ...
          <div class="flex justify-center items-center slide-left" id="right-panel">
            ...
            <form id="login-form" method="POST"> 
              ...
              <!-- Greetings Wrapper -->
                <div class="my-7 border-l-[3px] border-[#5e17eb] pl-4">

                  <p class="text-xs tracking-wide text-[#5e17eb] font-semibold mb-1.5">WELCOME BACK, AITEANS</p>
                  <h1 class="text-2xl font-semibold text-gray-900 mb-1.5">Sign in to your account</h1>
                  <p class="text-xs text-gray-400 leading-relaxed max-w-md">
                    Access the Teacher Evaluation System with the features available to your assigned role.
                  </p>
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      <span class="absolute left-4 top-2 md:left-4 md:top-2">
                        <i class="absolute top-1 left-2 fa-solid fa-user text-[#5e17eb] text-lg md:text-xl"></i>
                      </span>
                ...
                <!-- Password -->
                  <div>
                    ...
                    <div class="relative">
                      ...
                      <input class="bg-gray-100 w-full font-roboto py-3 px-15 text-sm shadow-md rounded-sm focus:border-purple-900 focus:outline-2 focus:outline-purple-900 md:py-3 md:text-md" type="password" name="password" id="inputPassword" placeholder="Enter your password" required>
                      ...
                      <div class="absolute right-12 top-4">
                        ...
                        <div class="relative">
                          ...
                          <span class="absolute -top-1 w-6 h-6 cursor-pointer" id="hidden">
                            <img src="/Smart-Eval/public/assets/icons/show.png" alt="hidden.png">
                          </span>

                          <span class="absolute w-6 h-6 -top-1 hidden cursor-pointer" id="show">
                            <img src="/Smart-Eval/public/assets/icons/view.png" alt="show.png">
                          </span>
              ...
              <div class="my-6">
                ...
                <input class="w-full bg-[#6010ff] text-white font-semibold text-sm py-3.5 rounded-2xl cursor-pointer hover:opacity-75" type="submit" name="signin-btn" value="Sign In" id="signin-btn">
              ...
              <div class="flex items-center gap-3 mb-5">
                ...
                <span class="text-xs text-[#6010ff]/50">New to Smart-Eval?</span>
                <div class="flex-1 h-px bg-purple-50"></div>
              </div>
              ...
              <p class="text-center text-sm text-gray-500">
                ...
                <button class="text-[#6010ff] font-semibold hover:text-purple-900 transition-colors" id="signup-link"
                  href="">Create one for teacher evaluation.</button>
              </p>

              <!-- Security note -->
              <div class="flex items-center justify-center gap-2 mt-6 pt-5 border-t border-purple-50">

                <svg class="w-3 h-3 text-[#6010ff]/50" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
