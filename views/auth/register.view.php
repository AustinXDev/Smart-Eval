    ...
    <div class="animate-fade-slide w-lg bg-white h-full w-full shadow-lg/20 overflow-hidden px-6 pb-12 pt-2 md:h-auto md:w-auto md:px-12 md:pb-15 md:w-xl md:rounded-lg"> <!-- Login Wrapper -->
      <form id="signUpForm" method="POST"> 
        ...
        <div class="mt-10 my-8 my-5 md:my-6 md:my-8"> <!-- Greetings Wrapper -->
          <h1 class="font-roboto text-lg text-purple-900 font-bold md:text-xl">New here, AITEans!</h1>
        ...
        <div class="flex flex-col gap-7 md:gap-10"> <!-- Inputs Wrapper -->
          ...
          <div class="relative">
            <span class="absolute left-5 top-3 md:left-4 md:top-4">
          ...
          <div class="relative">
            <span class="absolute left-5 top-3.5 md:left-4 md:top-4">
              <img class="w-6 h-6 md:w-7 md:h-7" src="../../public/assets/icons/approve.png" alt="password-icon.png">
            </span>
            <div></div>
