...
<body class="bg-[url('../../public/assets/images/BG-login.png')] bg-cover bg-center h-screen w-screen">
    ...
    <div class="animate-fade-slide h-full w-full bg-white  shadow-lg/20 overflow-hidden px-6 pb-12 pt-2 md:h-auto md:w-auto  md:rounded-lg md:px-12 md:pb-15 md:w-lg"> <!-- Create Password Wrapper -->
      <form id="forgot-password-form" method="post">
        ...
        <div class="mt-10 my-8 my-5 md:my-6 md:my-8"> <!-- Greetings Wrapper -->
          <h1 class="font-roboto text-2xl text-purple-900 font-bold md:text-3xl">Create New Password</h1>
          <p class="font-roboto text-gray-500 text-sm md:text-md">Your new password must be different from previously used 
          passwords.</p>
        </div>
        ...
        <div class="flex flex-col gap-7 md:gap-10"> <!-- Inputs Wrapper -->
          ...
          <div class="relative">
              ...
              <div></div>
              <input class="bg-gray-100 w-full font-roboto py-4 pl-15 text-sm shadow-md rounded-sm focus:border-purple-900 focus:outline-2 focus:outline-purple-900 md:py-4 md:text-lg" type="password" name="re-enter-password" id="inputConfirmPassword" placeholder="Confirm Password" required>
              <div class="absolute right-12 top-4">
                <div class="relative">
  ...
  <script src="../../public/assets/js/auth/reset_password.js" type="module"></script>
