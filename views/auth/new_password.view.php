     ...
     <!-- Create Password Wrapper -->
        <div class="animate-fade-slide h-full w-full bg-white  shadow-lg/20 overflow-hidden px-6 pb-12 pt-2 md:h-auto md:w-auto  md:rounded-lg md:px-12 md:pb-15 md:w-lg">
          ...
          <form id="forgot-password-form" method="post">
            ...
            <div class="mt-7"> <!-- Greetings Wrapper -->
              <h1 class="font-roboto text-xl font-bold text-[#1E0F4E] mb-1">Create New Password</h1>
              <p class="font-roboto text-gray-400 text-sm">Your new password must be different from previously used 
              passwords.</p>
            </div>
            ...
            <div class="mt-10">
              <input class="w-full bg-purple-900 text-white font-semibold text-sm py-3 rounded-xl cursor-pointer hover:opacity-75 md:text-sm" type="submit" name="reset-btn" value="Reset Password" id="reset-btn">
            </div>
          </form>
