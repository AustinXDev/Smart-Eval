<h1 class="text-md font-semibold"><span><?php echo strtoupper($department); ?></span> Dashboard</h1>

<!-- Card Container -->
<div id="card-container" class="px-2 mt-5 grid grid-cols-1 md:grid-cols-2 gap-4 lg:px-5 py-2">

  <!-- Total Students -->
  <div class="group flex items-center gap-4 px-6 py-5 rounded-xl border border-purple-100 bg-white hover:-translate-y-1 hover:bg-[#2D1B69] hover:shadow-lg hover:shadow-purple-200 transition-all duration-300">
    <div class="bg-purple-100 group-hover:bg-white/10 p-3 rounded-xl transition-colors duration-300 flex-shrink-0">
      <svg class="w-7 h-7 text-purple-600 group-hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="flex-1 min-w-0">
      ...
      <div id="totalStudents" class="text-2xl font-bold text-[#1E0F4E] group-hover:text-white"></div>
    </div>
  </div>

  <!-- Total Teachers -->
  <div class="group flex items-center gap-4 px-6 py-5 rounded-xl border border-amber-100 bg-white hover:-translate-y-1 hover:bg-amber-800 hover:shadow-lg hover:shadow-amber-200 transition-all duration-300">
    <div class="bg-amber-100 group-hover:bg-white/10 p-3 rounded-xl transition-colors duration-300 flex-shrink-0">
      <svg class="w-7 h-7 text-amber-600 group-hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor">
  ...
  <!-- Academic Period -->
  <div class="group flex items-start gap-4 px-6 py-5 rounded-xl border border-purple-100 bg-white hover:-translate-y-1 hover:bg-[#2D1B69] hover:shadow-lg hover:shadow-purple-200 transition-all duration-300">
    <div class="bg-purple-100 group-hover:bg-white/10 p-3 rounded-xl transition-colors duration-300 flex-shrink-0 mt-0.5">
      <svg class="w-7 h-7 text-purple-600 group-hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor">
    ...
    <div id="card-content" class="flex flex-col flex-1 min-w-0">
      ...
      <div class="text-lg font-bold text-[#1E0F4E] group-hover:text-white mb-2">
  ...
  <div class="group flex items-start gap-4 px-6 py-5 rounded-xl border border-green-100 bg-white hover:-translate-y-1 hover:bg-green-900 hover:shadow-lg hover:shadow-green-200 transition-all duration-300">
    <div class="bg-green-100 group-hover:bg-white/10 p-3 rounded-xl transition-colors duration-300 flex-shrink-0 mt-0.5">
      <svg class="w-7 h-7 text-green-700 group-hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 0 1-1.043 3.296 3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746 3.746 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z"/>
      </svg>
    </div>
    <div class="flex-1 min-w-0">
      <p class="text-xs font-medium text-green-600 group-hover:text-green-300 tracking-wide mb-1">Evaluation Status</p>
      <h1 class="text-base font-semibold text-[#1E0F4E] group-hover:text-white mb-3">Evaluation Completion Rate</h1>
      <div id="progress-bar" class="w-full bg-green-100 group-hover:bg-white/20 rounded-full h-2.5 overflow-hidden transition-colors duration-300">
        <div id="progress-fill" class="bg-green-700 group-hover:bg-green-300 h-2.5 rounded-full w-0 transition-all duration-1000"></div>
      </div>
      <div id="percentage" class="text-right mt-2 text-sm font-medium text-green-700 group-hover:text-green-200"></div>
    </div>
  </div>
...
<div class="p-0 lg:p-5 mt-5">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="lg:col-span-2 bg-white rounded-lg [box-shadow:rgba(0,0,0,0.02)_0px_1px_3px_0px,rgba(27,31,35,0.15)_0px_0px_0px_1px] p-5 hover:-translate-y-2 transition-all duration-300 hover:bg-gray-100  ">
      ...
      <div class="mb-4"> <!-- Header -->
        <h1 class="text-sm font-semibold text-gray-800 tracking-wide">Teacher Performance Ranking</h1>
      </div>
  ...
  <div class="p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-0
            border border-purple-100 rounded-xl bg-white mt-7 overflow-hidden">

  <!-- Students Who Evaluated -->
  <div class="flex flex-col gap-4 px-6 py-5 border-b sm:border-b-0 sm:border-r border-purple-100 hover:bg-purple-50/40 transition-colors duration-200">
    <div class="flex items-center gap-3 pb-4 border-b border-purple-100">
      ...
      <p class="text-sm font-medium text-purple-700">Students Who Evaluated</p>
    </div>
    <div class="flex items-center justify-between">
      <div class="flex flex-col gap-0.5">
        <span id="evaluated-total" class="text-3xl font-semibold text-[#1E0F4E]"></span>
        <span id="evaluated-label" class="text-xs text-purple-400">Total evaluated</span>
      </div>
  ...
  <div class="flex flex-col gap-4 px-6 py-5 border-b sm:border-b-0 lg:border-r border-purple-100 hover:bg-red-50/40 transition-colors duration-200">
    <div class="flex items-center gap-3 pb-4 border-b border-red-100">
      ...
      <p class="text-sm font-medium text-red-600">Students Who Did Not Evaluate</p>
    </div>
    <div class="flex items-center justify-between">
      <div class="flex flex-col gap-0.5">
        <span id="not-evaluated-total" class="text-3xl font-semibold text-red-800"></span>
        <span id="not-evaluated-label" class="text-xs text-red-300">Not evaluated</span>
      </div>
  ...
  <div class="flex flex-col gap-4 px-6 py-5 hover:bg-blue-50/40 transition-colors duration-200">
    <div class="flex items-center gap-3 pb-4 border-b border-blue-100">
      ...
      <p class="text-sm font-medium text-blue-700">Total Evaluations Submitted</p>
    </div>
    <div class="flex items-center justify-between">
      <div class="flex flex-col gap-0.5">
        <span id="submitted-total" class="text-3xl font-semibold text-blue-900"></span>
        <span id="submitted-label" class="text-xs text-blue-300">Submissions</span>
      </div>
