...
<body>
  ...
  <main class="pt-22 lg:ml-90 p-6  min-h-screen">
    <?php require __DIR__ . '/../pages/evaluation_period_content.php'?>
  </main>

  <!-- Modal Content -->
  <?php require __DIR__ . '/../../app/modals/periods/create_evaluation_modal.php'; ?>
  <?php require __DIR__ . '/../../app/modals/periods/confirmation_modal.php'; ?>


<script src="../../public/assets/js/admin/evaluation_periods/actions.js" type="module"></script>
<script src="../../public/assets/js/admin/evaluation_periods/table.js" type="module"></script>
</body>
</html>