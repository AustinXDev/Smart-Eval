...
<body class="min-h-screen w-screen overflow-hidden relative flex items-center justify-center" style="background: linear-gradient(135deg, #1E0F4E 0%, #2D1B69 40%, #4C1D95 70%, #6D28D9 100%);">
  ...
  <!-- Wrapper -->
    <div class="overflow-hidden h-screen flex justify-center items-center relative"> 
      ...
      <!-- Login Wrapper -->
        <div class="animate-fade-slide h-full w-full bg-white shadow-lg/20 overflow-hidden px-6 pb-12 pt-2 md:h-auto md:w-auto  md:rounded-lg md:px-12 md:pb-8 md:w-lg">
          ...
          <form id="login-form" method="POST"> 
            ...
            <!-- Greetings Wrapper -->
              <div class="my-7"> 
                <h1 class="font-roboto text-xl font-bold text-[#1E0F4E] mb-1">Administrator Portal</h1>
                <p class="font-roboto text-gray-500 text-sm">Access the management dashboard to oversee evaluations.</p>
              </div>
                ...
                <!-- Admin Username Input -->
                  <div>
                    ...
                    <div class="relative ">
                      ...
                      <input class="bg-gray-100 w-full font-roboto py-3 pl-15 text-sm shadow-md rounded-sm focus:border-purple-900 focus:outline-2 focus:outline-purple-900 md:py-4 md:text-md" type="text" name="admin_username" id="inputAdminUserName" placeholder="Admin Username" required>
                ...
                <!-- Admin Password Input -->
                  <div>
                    ...
                    <div class="relative">
                      ...
                      <input class="bg-gray-100 w-full font-roboto py-3 pl-15 text-sm shadow-md rounded-sm focus:border-purple-900 focus:outline-2 focus:outline-purple-900 md:py-4 md:text-md" type="password" name="password" id="inputAdminPassword" placeholder="Password" required>

                      <div class="absolute right-12 top-4">
                        <div class="relative">
                          <span class="absolute -top-1 w-6 h-6 md:w-6 md:h-6 cursor-pointer md:top-0" id="hidden"><img src="../../public/assets/icons/show.png" alt="hidden.png"></span>
                          <span class="absolute w-7 h-7 md:w-6 md:h-6 -top-1 hidden cursor-pointer md:top-0" id="show"><img src="../../public/assets/icons/view.png" alt="show.png"></span>
                        </div>
                      </div>
