    ...
    <div class="animate-fade-slide h-full w-full bg-white  shadow-lg/20 overflow-hidden px-6 pb-12 pt-2 md:h-auto md:w-auto  md:rounded-lg md:px-12 md:pb-15 md:w-lg"> <!-- Forgot Password Wrapper -->
      <form id="forgot-password-form" method="POST">
        ...
        <div class="mt-10 my-8 my-5 md:my-6 md:my-8"> <!-- Greetings Wrapper -->
          <h1 class="font-roboto text-2xl text-purple-900 font-bold md:text-3xl">Admin Password Reset</h1>
          <p class="font-roboto text-gray-500 text-sm md:text-md">Enter your registered username to recover your account.
          </p>
        </div>
        ...
        <div class="relative">
          <div>
            ...
            <input class="bg-gray-100 w-full font-roboto py-4 pl-17 text-sm shadow-md rounded-sm focus:border-purple-900 focus:outline-2 focus:outline-purple-900 md:py-4 md:text-lg" type="text" name="identifier" id="inputAdmin" placeholder="Admin Username" required>
          </div>
        </div>
        ...
        <div class="mt-5">
          <p class="text-center text-sm font-light md:text-md" >Wait, I remember now! <a class="text-purple-900 font-semibold underline" href="login.view.php">Go back to admin login</a></p>
        </div>
