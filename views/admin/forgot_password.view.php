      ...
      <!-- Forgot Password Wrapper -->
        <div class="animate-fade-slide h-full w-full bg-white  shadow-lg/20 overflow-hidden px-6 pb-12 pt-2 md:h-auto md:w-auto  md:rounded-lg md:px-12 md:pb-15 md:w-lg">
          ...
          <form id="forgot-password-form" method="POST">
            ...
            <!-- Greetings Wrapper -->
              <div class="my-7"> 
                <h1 class="font-roboto text-xl font-bold text-[#1E0F4E] mb-1">Admin Password Reset</h1>
                <p class="font-roboto text-gray-500 text-sm">Enter your registered username to recover your account.
                </p>
              </div>
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <div>
                    ...
                    <input class="bg-gray-100 w-full font-roboto py-3 pl-17 text-sm shadow-md rounded-sm focus:border-purple-900 focus:outline-2 focus:outline-purple-900 md:py-4 md:text-md" type="text" name="identifier" id="inputAdmin" placeholder="Admin Username" required>
            ...
            <div class="mt-5">
              <p class="text-center text-sm text-gray-500" >Wait, I remember now! <a class="text-purple-700 font-semibold hover:text-purple-900 transition-colors" href="login.view.php">Go back to admin login</a></p>
            </div>
