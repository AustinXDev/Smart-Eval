...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        if(passwordValue.length < 8 || !/[0-9]/.test(passwordValue) ||  !/[!@#$%^&*(),.?":{}|<>]/.test(passwordValue)){
            notify('warning', 'Password must be at least 8 characters and include a number and special character');
            return;
        }
