...
if(!token){
  ...
  window.location.href = '../../views/auth/forgot_password.view.php';
}
...
form.addEventListener('submit', async e => {
  ...
  try{
    ...
    const res = await fetch('../../app/auth/password_reset.php', {
      method: 'POST',
    ...
    if(data.status === 'success'){
      setTimeout(() => {
        window.location.href = '../../views/auth/login.view.php';
      }, 2000);
    }
